...
--Event and Damage option values
SCT.LOCALS.OPTION_EVENT1 = {name = "Повреждения", tooltipText = "Enables or Disables melee and misc. (fire, fall, etc...) damage"};
SCT.LOCALS.OPTION_EVENT2 = {name = "Промах", tooltipText = "Enables or Disables melee misses"};
SCT.LOCALS.OPTION_EVENT3 = {name = "Уворот", tooltipText = "Enables or Disables melee dodges"};
SCT.LOCALS.OPTION_EVENT4 = {name = "Парирован", tooltipText = "Enables or Disables melee parries"};
SCT.LOCALS.OPTION_EVENT5 = {name = "Блок", tooltipText = "Enables or Disables melee blocks and partial blocks"};
SCT.LOCALS.OPTION_EVENT6 = {name = "Дамаг Спеллами", tooltipText = "Enables or Disables spell damage"};
SCT.LOCALS.OPTION_EVENT7 = {name = "Хилл Спеллами", tooltipText = "Enables or Disables spell heals"};
SCT.LOCALS.OPTION_EVENT8 = {name = "Резист Спеллов", tooltipText = "Enables or Disables spell resists"};
SCT.LOCALS.OPTION_EVENT9 = {name = "Дебаффы", tooltipText = "Enables or Disables showing when you get debuffs"};
...
SCT.LOCALS.OPTION_EVENT11 = {name = "Мало HP", tooltipText = "Enables or Disables showing when you have low health"};
SCT.LOCALS.OPTION_EVENT12 = {name = "Мало Маны", tooltipText = "Enables or Disables showing when you have low mana"};
SCT.LOCALS.OPTION_EVENT13 = {name = "Очки ярости", tooltipText = "Enables or Disables showing when you gain Mana, Rage, Energy from potions, items, buffs, etc...(Not regular regen)"};
SCT.LOCALS.OPTION_EVENT14 = {name = "Combat Flags", tooltipText = "Enables or Disables showing when you enter or leave combat"};
SCT.LOCALS.OPTION_EVENT15 = {name = "Очки Ярости", tooltipText = "Enables or Disables showing when you gain combo points"};
...
SCT.LOCALS.OPTION_EVENT17 = {name = "Бафф", tooltipText = "Enables or Disables showing when you gain buffs"};
SCT.LOCALS.OPTION_EVENT18 = {name = "Buff Fades", tooltipText = "Enables or Disables showing when you lose buffs"};
SCT.LOCALS.OPTION_EVENT19 = {name = "Активные скиллы", tooltipText = "Enables or Disables alerting when a skill becomes active (Execute, Mongoose Bite, Hammer of Wrath, etc...)"};
SCT.LOCALS.OPTION_EVENT20 = {name = "Репутация", tooltipText = "Enables or Disables showing when you gain or lose Reputation"};
SCT.LOCALS.OPTION_EVENT21 = {name = "Ващ Хилл", tooltipText = "Enables or Disables showing how much you heal others for"};
SCT.LOCALS.OPTION_EVENT22 = {name = "Скиллы", tooltipText = "Enables or Disables showing when you gain Skill points"};
SCT.LOCALS.OPTION_EVENT23 = {name = "Убиственный удар", tooltipText = "Enables or Disables showing when you get a killing blow"};
SCT.LOCALS.OPTION_EVENT24 = {name = "Промежутки", tooltipText = "Enables or Disables showing when you are interrupted"};

--Check Button option values
SCT.LOCALS.OPTION_CHECK1 = { name = "Отключить SCT", tooltipText = "Enables or Disables the Scrolling Combat Text"};
...
SCT.LOCALS.OPTION_CHECK20 = { name = "Оключить Icons", tooltipText = "Enables or Disables showing icons for spells and skills"};
...
--Misc option values
SCT.LOCALS.OPTION_MISC1 = {name="SCT Опции "..SCT.version, tooltipText = "Left Click to Drag"};
...
SCT.LOCALS.OPTION_MISC13 = {name="Текст опции" };
...
SCT.LOCALS.OPTION_MISC19 = {name="Спеллы"};
SCT.LOCALS.OPTION_MISC20 = {name="Frame 2"};
SCT.LOCALS.OPTION_MISC21 = {name="Походы"};
...
SCT.LOCALS.OPTION_SELECTION3 = { name="Font", tooltipText = "What font to use", table = SML:List("font")};
SCT.LOCALS.OPTION_SELECTION4 = { name="Font Outline", tooltipText = "What font outline to use", table = {[1] = "None",[2] = "Thin",[3] = "Thick"}};
SCT.LOCALS.OPTION_SELECTION5 = { name="Message Font", tooltipText = "What font to use for messages", table = SML:List("font")};
