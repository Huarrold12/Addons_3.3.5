...
local function UpdateTotemIconWidget(self, unit)
	...
	if totem and db.totemWidget.ON and db.totemSettings[totem][6] then
...
---------------------------------------
-- Example OnInitialize and OnUpdate --
---------------------------------------
--[[
...
TidyPlatesThemeList["YOUR_THEME"].OnInitialize = OnInitialize
TidyPlatesThemeList["YOUR_THEME"].OnUpdate = OnUpdate
